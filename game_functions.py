...
def check_play_button(ai_settings,screen,stats,sb,
    play_button,ship,aliens,bullets,mouse_x,mouse_y):
    #wan jia dian ji "play" an niu shi you xi kai shi 
...
def check_bullet_alien_collisions(ai_settings,screen,stats,sb,ship,
    ...
    if len(aliens) == 0:
        ...
        #shan chu xian you de zi dan bing chuan jian yi qun wai xing ren
        bullets.empty()
...
def create_fleet(ai_settings,screen,ship,aliens):
    """chaung jian wai xiang ren qun"""
    alien = Alien(ai_settings,screen)
    number_aliens_x = get_number_aliens_x(ai_settings,alien.rect.width)
    number_rows = get_number_rows(ai_settings,ship.rect.height,
        alien.rect.height)

    #chaung jian di yi hang wai xing ren
    for row_number in range(number_rows):
        for alien_number in range(number_aliens_x):
        
        #chuang jian yige wai xing ren bing ba ta jia ru dang qian hang
...
def ship_hit(ai_settings,screen,stats,sb,ship,aliens,bullets):
    if stats.ships_left > 0:
        ...
        stats.ships_left -= 1
#qingkong wai xing ren he zi dan 
        sb.prep_ships()
        aliens.empty()
        bullets.empty()
...
def check_high_score(stats,sb):
    #jian cha shi fou dan sheng le zui gao fen
